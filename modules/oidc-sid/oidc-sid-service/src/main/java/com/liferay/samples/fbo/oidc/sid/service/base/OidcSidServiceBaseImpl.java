...
public abstract class OidcSidServiceBaseImpl
	extends BaseServiceImpl implements IdentifiableOSGiService, OidcSidService {
	 ...
	 */
	public com.liferay.samples.fbo.oidc.sid.service.OidcSidLocalService
		getOidcSidLocalService() {
	...
	public void setOidcSidLocalService(
		com.liferay.samples.fbo.oidc.sid.service.OidcSidLocalService
			oidcSidLocalService) {
	...
	/**
	 * Returns the oidc sid remote service.
	 *
	 * @return the oidc sid remote service
	 */
	public OidcSidService getOidcSidService() {
		return oidcSidService;
	}

	/**
	 * Sets the oidc sid remote service.
	 *
	 * @param oidcSidService the oidc sid remote service
	 */
	public void setOidcSidService(OidcSidService oidcSidService) {
		this.oidcSidService = oidcSidService;
	}
	...
	@BeanReference(
		type = com.liferay.samples.fbo.oidc.sid.service.OidcSidLocalService.class
	)
	protected com.liferay.samples.fbo.oidc.sid.service.OidcSidLocalService
		oidcSidLocalService;

	@BeanReference(type = OidcSidService.class)
