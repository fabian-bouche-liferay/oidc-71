...
/**
 * Provides the local service interface for OidcSid. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see OidcSidLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface OidcSidLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.samples.fbo.oidc.sid.service.impl.OidcSidLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the oidc sid local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link OidcSidLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public OidcSid addOidcSid(OidcSid oidcSid);
	...
	public OidcSid createOidcSid(long OidcSidId);
	...
	public OidcSid deleteOidcSid(long OidcSidId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public OidcSid deleteOidcSid(OidcSid oidcSid);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OidcSid fetchOidcSid(long OidcSidId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OidcSid fetchOidcSidByUuidAndCompanyId(String uuid, long companyId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ActionableDynamicQuery getActionableDynamicQuery();

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OidcSid getBySessionId(String sessionId)
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OidcSid getOidcSid(long OidcSidId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OidcSid getOidcSidByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OidcSid> getOidcSids(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public OidcSid updateOidcSid(OidcSid oidcSid);
